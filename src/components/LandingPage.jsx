...
function LandingPage() {
  ...
  return (
    <div class="h-full flex flex-col justify-center items-center bg-gradient-to-br from-green-100 to-blue-100 p-4">
      ...
      <button
        class="px-12 py-6 bg-green-500 text-white text-2xl rounded-lg cursor-pointer hover:bg-green-600 transition duration-300 ease-in-out transform hover:scale-105 cursor-pointer"
