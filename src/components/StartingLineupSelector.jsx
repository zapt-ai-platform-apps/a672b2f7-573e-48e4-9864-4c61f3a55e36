  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-8 rounded-md shadow-md mb-8">
      ...
      <p className="mb-4 text-gray-700 dark:text-gray-300 text-lg">
        Select the players who will participate in this match. {startingPlayersCount}{" "}
        {startingPlayersCount === 1 ? "player is" : "players are"} selected.
      </p>
      <ul>
          ...
          <li key={index} className="mb-4">
            <label className="flex items-center cursor-pointer">
              <input
                ...
                className="mr-4 w-6 h-6 accent-green-600 border border-gray-300 rounded cursor-pointer"
              />
