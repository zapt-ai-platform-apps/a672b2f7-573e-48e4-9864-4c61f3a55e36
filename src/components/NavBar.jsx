...
function NavBar() {
  return (
    <nav class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm transition-shadow duration-200 ease-in-out-custom">
      <div class="container mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="flex items-center space-x-4 mt-4 md:mt-0">
          <a
            ...
            class="text-gray-800 dark:text-white hover:text-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-400 transition-colors duration-300 ease-in-out-custom cursor-pointer"
          >
            Made on ZAPT
          </a>
          <a
