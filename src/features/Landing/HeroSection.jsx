...
const HeroSection = ({ onGetStarted }) => (
  <div className="text-center">
    <img
      ...
      className="w-40 h-40 mb-6 rounded-full shadow-lg animate-bounce"
      data-image-request="A football icon with substitutions arrows"
    />
    <h1 className="text-6xl font-extrabold text-white mb-4 drop-shadow-lg">Football Subs</h1>
    <p className="text-xl text-gray-100 mb-8 max-w-2xl mx-auto">
      Effortlessly manage your team's substitutions, track game events, and ensure fair playtime for every player.
    </p>
    <button
      onClick={onGetStarted}
      className="px-8 py-4 bg-white text-purple-700 text-2xl rounded-full cursor-pointer hover:bg-gray-200 transition transform hover:scale-105 shadow-lg"
    >
      Get Started
    </button>
  </div>
